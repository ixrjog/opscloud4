...
<!-- Top Subscribe Option Starts Here -->

<!-- Top Subscribe Option Ends Here -->
...
<!-- Issue Part Ends Here -->

<!-- Newsletter Heading Starts Here -->
...
<!-- Newsletter Heading Ends Here -->



<div style="margin:10px;clear:both;margin-top:15px;padding-bottom:10px;border-bottom:1px dashed #cccccc;">
<p><span style="padding:2px 4px 2px 4px;font-size:13px;color:#ffffff;background:#666666;"><b>${workflowTitle}</b></span></p>
...
<!-- Detailed Description Ends Here -->
