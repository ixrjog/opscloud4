...
import com.baiyi.opscloud.jumpserver.model.AssetsPermission;

import java.util.Map;

public class PermissionApi extends BaseApi {

    public PermissionApi(String url, String token) {
        this.URL = url;
        this.TOKEN = token;
    }

    public PermissionApi(String url, String username, String password) {
