...
public class WorkOrderSerDeployHelper {
    ...
    public WorkOrderSerDeployToken get(Integer applicationId) {
        return (WorkOrderSerDeployToken) redisUtil.get(getKey(applicationId));
    }

    public void set(WorkOrderSerDeployToken token) {
