...
@Slf4j
@Component
public class ApplicationScaleReplicasTicketProcessor
    ...
    protected void processHandle(WorkOrderTicketEntry ticketEntry, ApplicationScaleReplicasEntry.KubernetesDeployment entry) throws TicketProcessException {
        ...
        try {
            KubernetesDeploymentDriver.scale(config, entry.getNamespace(), entry.getDeploymentName(), entry.getScaleReplicas());
