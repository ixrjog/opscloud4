...
import com.baiyi.caesar.sshserver.listeners.SshShellListenerService;
import com.baiyi.caesar.sshserver.postprocess.PostProcessor;
import com.baiyi.caesar.sshserver.postprocess.TypePostProcessorResultHandler;
import com.baiyi.caesar.sshserver.postprocess.provided.*;
import com.baiyi.caesar.sshserver.providers.ExtendedFileValueProvider;
...
import static com.baiyi.caesar.sshserver.SshShellCommandFactory.SSH_THREAD_CONTEXT;
import static com.baiyi.caesar.sshserver.SshShellProperties.SSH_SHELL_ENABLE;
...
@ComponentScan(basePackages = {"com.baiyi.caesar.sshserver"})
