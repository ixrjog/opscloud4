...
public class VirtualServiceConverter {
    ...
    public static AssetContainer toAssetContainer(DatasourceInstance dsInstance, VirtualService entity) {
        ...
        DatasourceInstanceAsset asset = DatasourceInstanceAsset.builder()
                ...
                .assetKey2(namespace)
                .kind(entity.getKind())
                .assetType(DsAssetTypeConstants.ISTIO_VIRTUAL_SERVICE.name())
