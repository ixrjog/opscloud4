package com.baiyi.opscloud.zabbix.v5.datasource.base;
...
public abstract class AbstractZabbixV5ActionDatasource {
    ...
    @Resource
    protected ZabbixV5UserGroupDatasource zabbixV5UserGroupDatasource;

    @Resource
    protected ZabbixV5HostGroupDatasource zabbixV5HostGroupDatasource;
