package com.baiyi.opscloud.zabbix.v5.drive.base;
...
public abstract class AbstractZabbixV5ActionDrive {
    ...
    @Resource
    protected ZabbixV5UserGroupDrive zabbixV5UserGroupDatasource;

    @Resource
    protected ZabbixV5HostGroupDrive zabbixV5HostGroupDatasource;
