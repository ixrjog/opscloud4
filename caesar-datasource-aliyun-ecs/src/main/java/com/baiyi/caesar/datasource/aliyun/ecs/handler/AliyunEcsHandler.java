...
import static com.baiyi.caesar.datasource.aliyun.ecs.common.BaseAliyunHandler.Query.PAGE_SIZE;
...
public class AliyunEcsHandler {
    ...
    public List<DescribeInstancesResponse.Instance> listInstances(String regionId, DsAliyunConfig.Aliyun aliyun) {
    ...
    public List<DescribeImagesResponse.Image> listImages(String regionId, DsAliyunConfig.Aliyun aliyun) {
