...
INSERT INTO `oc_ansible_playbook` VALUES (10,'2438ed041ef64688913ac6407f7ad99e','test','---\n- hosts: \"{{ hosts }}\"\n  tasks:\n    - name: test\n      tags: test\n      debug: msg=\"env = {{ env }}, serverName = {{ serverName }}\"\n    - name: test2\n      tags: test2\n      shell: pwd\n    - name: test3\n      tags: test3\n      ping:\n    - name: test4\n      tags: test4\n      ping:\n    - name: test5\n      tags: test55\n      ping:',NULL,'tasks:\n  - name: 测试1\n    tags: test\n  - name: 测试2\n    tags: test2\n  - name: 测试3\n    tags: test3\n  - name: 测试4\n    tags: test4\n  - name: 测试5\n    tags: test55\n    choose: false','vars:\n  env: dev\n  serverName: server-test-2',0,NULL,NULL,'2020-04-13 09:22:11','2020-04-14 07:33:29'),(13,'0c3967f438064014821bdc5aa906dfc6','initCloudServer','---\n- name: init aliyun ecs\n  include: \"{{ basePath }}/aliyunECS.yml\"\n  when: cloudServerType == \"ECS\"\n- name: init aws ec2\n  include: \"{{ basePath }}/awsEC2.yml\"\n  when: cloudServerType == \"EC2\"',NULL,'tasks:\n  - name: 初始化基础配置，包含hostname、yum、时区 \n    tags: base\n  - name: 初始化dns \n    tags: dns\n  - name: 安装logtail  \n    tags: logtail\n  - name: 安装中间件相关包 \n    tags: middleware\n  - name: 安装压测监控agent包 \n    tags: mon-qa\n  - name: 初始化应用发布相关 \n    tags: app-deploy','vars:\n  basePath: /data/opscloud-data/ansible/playbook/init-cloud-server',357,'{\"createTime\":1587572054000,\"displayName\":\"修远\",\"email\":\"xiuyuan@gegejia.com\",\"id\":357,\"isActive\":true,\"password\":\"\",\"phone\":\"15067127069\",\"source\":\"ldap\",\"updateTime\":1587572054000,\"username\":\"xujian\",\"uuid\":\"cbfbebd87fbb422d95121b21683cd380\"}',NULL,'2020-04-26 03:45:26','2020-04-26 03:45:26'),(14,'15c74b0b6e5c48f7b9f00939155c3813','do-check-func','---\n- hosts: \"{{ hosts }}\"\n  tasks:\n    - name: doCheckFunc\n      shell: /opt/bin/appctl.sh checkfunc\n      async: 60\n      poll: 2',NULL,NULL,NULL,357,'{\"createTime\":1589456003000,\"displayName\":\"修远\",\"email\":\"xiuyuan@gegejia.com\",\"id\":357,\"isActive\":true,\"password\":\"\",\"phone\":\"15067127069\",\"source\":\"ldap\",\"updateTime\":1589813945000,\"username\":\"xujian\",\"uuid\":\"4cefd6145aa3419ca2684e3345f713d1\"}',NULL,'2020-05-18 09:53:42','2020-05-18 09:53:42');
...
INSERT INTO `oc_env` VALUES (1,'default',0,'#888585','默认环境','2020-04-02 14:06:38','2020-04-02 14:06:38'),(2,'dev',1,'#5bc0de','开发环境','2020-01-10 05:53:51','2020-02-21 10:17:07'),(3,'test',5,'#5e5e5e','测试环境','2020-01-10 05:53:55','2020-02-21 10:18:53'),(4,'gray',3,'#ff8700','灰度环境','2020-03-11 06:03:58','2020-03-11 06:03:58'),(5,'prod',4,'#E34C15','生产环境','2020-02-22 05:13:16','2020-02-22 05:13:16'),(6,'daily',2,'#449d44','日常环境','2020-03-04 03:10:44','2020-03-04 03:10:44'),(14,'pre',7,'#A9A61D','预发环境','2020-03-11 06:05:28','2020-03-11 06:05:28');
...
INSERT INTO `oc_setting` VALUES (1,'SERVER','SERVER_ACCOUNT','user',0,'服务器默认登录账户','2020-06-04 07:39:50','2020-06-18 07:58:40'),(2,'SERVER','SERVER_HIGH_AUTHORITY_ACCOUNT','admin',0,'服务器高权限账户','2020-06-04 07:41:00','2020-06-04 07:42:07'),(3,'OPSCLOUD','VERSION','3.0.0',0,'版本号','2020-06-04 07:41:59','2020-06-04 07:42:32'),(27,'ORG','ORG_DEPT_ID','0',0,'组织架构拓扑根id','2020-06-16 02:02:40','2020-06-18 09:07:28');
...
-- Dump completed on 2020-06-18 17:40:03
