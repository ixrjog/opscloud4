...
/**
 * collection of convenient methods which use methods from {@link com.offbytwo.jenkins.JenkinsServer}
 * etc.
 * 
...
public class JenkinsTriggerHelper {
    ...
    private final com.offbytwo.jenkins.JenkinsServer server;
    private final Long retryInterval;
    private static final Long DEFAULT_RETRY_INTERVAL = 200L;

    public JenkinsTriggerHelper(com.offbytwo.jenkins.JenkinsServer server) {
        this.server = server;
