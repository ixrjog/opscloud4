...
public class FolderJob extends com.offbytwo.jenkins.model.Job {
     ...
     *
     * @return list of defined jobs (summary level, for details {@link com.offbytwo.jenkins.model.Job#details()}.
     */
    public Map<String, com.offbytwo.jenkins.model.Job> getJobs() {
