...
public class Build extends BaseModel {
    ...
    public static final Build BUILD_HAS_NEVER_RUN = new Build(-1, -1, "UNKNOWN") {
        @Override
        public com.offbytwo.jenkins.model.TestReport getTestReport() {
            return com.offbytwo.jenkins.model.TestReport.NO_TEST_REPORT;
        }

        @Override
        public com.offbytwo.jenkins.model.BuildWithDetails details() {
            // For a build which never has been run you couldn't get
            // details about!
            return com.offbytwo.jenkins.model.BuildWithDetails.BUILD_HAS_NEVER_RUN;
        }
    };
    ...
    public static final Build BUILD_HAS_BEEN_CANCELLED = new Build(-1, -1, "CANCELLED") {
        ...
        @Override
        public com.offbytwo.jenkins.model.BuildWithDetails details() {
            return com.offbytwo.jenkins.model.BuildWithDetails.BUILD_HAS_BEEN_CANCELLED;
        }
    };
     ...
     * @throws IOException in case of an error.
     */
    public com.offbytwo.jenkins.model.TestReport getTestReport() throws IOException {
     ...
     * @throws IOException in case of an error.
     */
    public com.offbytwo.jenkins.model.TestResult getTestResult() throws IOException {
