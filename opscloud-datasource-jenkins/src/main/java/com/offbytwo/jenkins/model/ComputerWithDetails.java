...
public class ComputerWithDetails extends Computer {
    ...
    private List<com.offbytwo.jenkins.model.Executor> executors;
    ...
    private com.offbytwo.jenkins.model.OfflineCause offlineCause;
     ...
     * (node) name.
     * 
     * @return {@link com.offbytwo.jenkins.model.LoadStatistics}
