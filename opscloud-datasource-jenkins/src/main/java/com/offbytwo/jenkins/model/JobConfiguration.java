...
public class JobConfiguration {
    ...
    public JobConfiguration addStringParam(String name, String desc, String defaultValue)
        ...
        com.offbytwo.jenkins.model.StringParameterDefinition spd = new com.offbytwo.jenkins.model.StringParameterDefinition(name, desc, defaultValue);
        if (null == nodes || 0 == nodes.size()) {
            com.offbytwo.jenkins.model.ParameterDefinitions pd = new ParameterDefinitions();
            pd.addParam(spd);
