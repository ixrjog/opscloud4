...
public class JobWithDetails extends com.offbytwo.jenkins.model.Job {
    ...
    private List<com.offbytwo.jenkins.model.Job> downstreamProjects;

    private List<com.offbytwo.jenkins.model.Job> upstreamProjects;
    ...
    public List<Build> getAllBuilds() throws IOException {
        ...
        try {
            List<Build> builds = client.get(path + "job/" + EncodingUtils.encode(this.getName())
                    + "?tree=allBuilds[number[*],url[*],queueId[*]]", com.offbytwo.jenkins.model.AllBuilds.class).getAllBuilds();
    ...
    public List<Build> getAllBuilds(Range range) throws IOException {
        ...
        try {
            List<Build> builds = client.get(path + range.getRangeString(), com.offbytwo.jenkins.model.AllBuilds.class).getAllBuilds();
     ...
     */
    public List<com.offbytwo.jenkins.model.Job> getDownstreamProjects() {
     ...
     */
    public List<com.offbytwo.jenkins.model.Job> getUpstreamProjects() {
