...
public class KubernetesDailyTest extends BaseKubernetesTest {
    ...
    void armsTest() {
        ...
        for (Application application : applications) {
            ...
            Deployment deployment = KubernetesDeploymentDriver.getDeployment(kubernetesConfig.getKubernetes(), "test", appName);
            ...
            if (optionalContainer.isPresent()) {
                ...
                KubernetesDeploymentDriver.createOrReplaceDeployment(kubernetesConfig.getKubernetes(), "test", deployment);
                print("---------------------------------------------------------------------------");
                print("应用名称: " + appName);
                print("---------------------------------------------------------------------------");
            }
