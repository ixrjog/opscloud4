...
public interface AliyunLogFacade {
    ...
    DataTable<AliyunLogVO.Log> queryLogPage(AliyunLogParam.PageQuery pageQuery);
    ...
    DataTable<AliyunLogMemberVO.LogMember> queryLogMemberPage(AliyunLogMemberParam.PageQuery pageQuery);
