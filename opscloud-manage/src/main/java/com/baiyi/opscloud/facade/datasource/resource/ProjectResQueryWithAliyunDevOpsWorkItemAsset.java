...
@ProjectResType(ProjectResTypeEnum.ALIYUN_DEVOPS_WORKITEM)
@BusinessType(BusinessTypeEnum.ASSET)
@Component
public class ProjectResQueryWithAliyunDevOpsWorkItemAsset extends AbstractProjectResQueryWithAsset {
}
