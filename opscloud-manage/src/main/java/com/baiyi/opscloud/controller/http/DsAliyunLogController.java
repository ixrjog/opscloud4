...
public class DsAliyunLogController {
    ...
    @Operation(summary = "删除指定的阿里云日志服务")
    ...
    @Operation(summary = "查询阿里云日志服务项目列表")
    ...
    @Operation(summary = "查询阿里云日志服务日志库列表")
    ...
    @Operation(summary = "查询阿里云日志服务配置列表")
    ...
    @Operation(summary = "分页查询阿里云日志服务成员列表")
    ...
    @Operation(summary = "删除指定的阿里云日志服务成员")
    ...
    @Operation(summary = "推送阿里云日志服务成员配置")
